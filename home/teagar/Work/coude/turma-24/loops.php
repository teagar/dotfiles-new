...
/*
  05 - Comente o echo|var_dump acima e:
...
$names = ['João Grilo', 'Chicó', 'Rosinha'];

/*
  06 - Comente o echo|var_dump acima e:
...
$numbers = ['91', '5', '30', '97', '83', '31'];

/*
  07 - Comente o echo|var_dump acima.
